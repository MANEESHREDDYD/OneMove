...
def test_c_dispatch_optional_integration():
    ...
    """
    orders_path = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "../../c/dispatch-engine/data/sample_orders.csv")
    )
    partners_path = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "../../c/dispatch-engine/data/sample_partners.csv")
    )
