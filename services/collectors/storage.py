...
def save_bronze_data(provider: str, dataset: str, dt: datetime, run_id: str, data: List[Dict[str, Any]], filename: str) -> None:
...
def save_silver_data(provider: str, dataset: str, dt: datetime, run_id: str, data: List[Dict[str, Any]], filename: str) -> None:
