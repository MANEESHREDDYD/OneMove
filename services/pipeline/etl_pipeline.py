...
MOCK_WEATHER = {"Z1": "Sunny", "Z2": "Rain", "Z3": "Cloudy"}

ZONE_MAPPING = {"Z1": "North Zone", "Z2": "South Zone", "Z3": "East Zone"}
    ...
    for row in data["rows"]:
        ...
        if h not in seen_hashes:
            ...
            bronze_row = {
                ...
                "_provenance": {"_source": "snapshot", "_loaded_at": datetime.utcnow().isoformat()},
            }
...
def step_dq(silver_path):
    ...
    report = {"completeness": 0, "invalid_eta_count": 0, "missing_intervals": 0, "failed_rows": []}
