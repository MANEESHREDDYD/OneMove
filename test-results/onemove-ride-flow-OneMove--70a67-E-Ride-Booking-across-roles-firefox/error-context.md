...
```
Error: Expected 0 console/network errors, but got 39:
...
Request failed: http://localhost:3000/customer/profile?_rsc=t__83lqWcB6J_fn4 - net::ERR_ABORTED
...
Request failed: http://localhost:3000/customer/profile?_rsc=uLDXMEvTsfmS9Vyq - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/profile?_rsc=4TSmZv_O8D02eePU - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/profile?_rsc=tQE-hG6fsLEfKJS7 - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/profile?_rsc=LNBCaV8yzI0KVH-f - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/profile?_rsc=tjy5Z0GCxyA8pkHi - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/grocery?_rsc=kGaAVozErJJrICHw - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/eats?_rsc=kGaAVozErJJrICHw - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/courier?_rsc=kGaAVozErJJrICHw - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/rides?_rsc=ORPS-ORdcOx2i9Vf - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/rides?_rsc=sblZDjpMzenNryC2 - net::ERR_ABORTED
Request failed: http://localhost:3000/?_rsc=AvXhMPqP1Hc9lSFm - net::ERR_ABORTED
