...
- Name: onemove-negative-flows.spec.ts >> OneMove E2E Negative & Edge Case Flows >> Auth Abuse: Stale session and manual URL entry rejection
- Location: tests\e2e\onemove-negative-flows.spec.ts:4:7

# Error details

```
Error: page.goto: Navigation to "http://localhost:3000/customer" is interrupted by another navigation to "http://localhost:3000/auth/login"
Call log:
  - navigating to "http://localhost:3000/customer", waiting until "load"
