...
```
Error: Expected 0 console/network errors, but got 52:
...
Request failed: http://localhost:3000/customer/profile?_rsc=sIvNRjiB3C3zlVsQ - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/profile?_rsc=7V_aI7AwC9OK_tfk - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/profile?_rsc=THsVSJsx5TFMTB_L - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/profile?_rsc=D19JY1xgPB0a9yVH - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/profile?_rsc=YwPNLy9aaMtitp3_ - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/courier?_rsc=7W24iUQRZDUZsTB3 - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/grocery?_rsc=7W24iUQRZDUZsTB3 - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/rides?_rsc=sIvNRjiB3C3zlVsQ - net::ERR_ABORTED
Request failed: http://localhost:3000/customer/rides?_rsc=rYGhuIorvCDyQQmn - net::ERR_ABORTED
Request failed: http://localhost:3000/customer?_rsc=7W24iUQRZDUZsTB3 - net::ERR_ABORTED
Request failed: http://localhost:3000/?_rsc=2KLCUY-Td312dtWY - net::ERR_ABORTED
