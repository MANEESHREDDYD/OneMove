          ...
          <table className="w-full text-sm text-left border">
            ...
            <tbody className="divide-y">
                ...
                <tr className="hover:bg-muted/50">
                  <td className="px-4 py-3">Demo Store</td>
                  <td className="px-4 py-3">Restaurant</td>
