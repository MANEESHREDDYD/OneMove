...
```
Error: page.waitForURL: Could not connect to server
=========================== logs ===========================
waiting for navigation to "**/partner**" until "load"
============================================================
```
      ...
      - generic [ref=e8]:
        - generic [ref=e9]:
          ...
          - textbox "Email" [ref=e11]:
            ...
            - text: partner001@onemove.demo
        - generic [ref=e12]:
          - generic [ref=e13]: Password
          - textbox "Password" [ref=e14]: Partner@001Move
