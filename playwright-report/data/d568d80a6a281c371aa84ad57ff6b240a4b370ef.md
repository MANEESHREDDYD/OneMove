...
- main:
  ...
  - heading "Where to?" [level=3]
  - text: Home • Work • Airport Pickup Location
  - textbox "Where from? (e.g. JFK Airport)"
  - text: Dropoff Location
  - textbox "Where to? (e.g. Times Square)"
  - paragraph: Select your pickup and dropoff locations to see live estimates and vehicle options.
  - button "Enter Destinations" [disabled]
  - text: All partners pass strict safety checks.
