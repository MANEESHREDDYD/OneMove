...
- Name: onemove-core-flows.spec.ts >> OneMove Core Marketplace E2E Flows >> Customer can add food and checkout
- Location: tests\e2e\onemove-core-flows.spec.ts:47:7
...
> 56 |     await page.waitForSelector('a[href^="/customer/eats/"]');
  ...
  72 |       await page.click('button', { hasText: 'Demo Wallet' });
